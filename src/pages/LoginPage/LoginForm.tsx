...
'h-11 bg-foreground border-border text-foreground placeholder:text-border placeholder:italic focus:border-ring focus:ring-0 focus-visible:ring-0 transition-all rounded-lg'
...
return (
  <Card className="w-full border-0 rounded-none shadow-none">
    <CardHeader className="space-y-2 text-left">
      <CardTitle className="text-[32px] font-bold leading-none mb-4">
        Вход
      </CardTitle>
    </CardHeader>
    ...
    <CardContent>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="">
          <div className="relative">
            <Input
              ...
              {...register('password')}
              className={`${baseInputClass} pr-10 rounded-xl`}
            />
          ...
          <div className="text-left mt-1">
            <a
              href="#"
              className="block h-4 text-xs leading-4 text-muted-foreground hover:underline"
            >
              Забыли пароль?
            </a>
          </div>
        ...
        <Button
          ...
          className="
            w-full h-12 mt-5 text-base font-semibold
